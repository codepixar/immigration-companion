...
class immigration_social_widget extends WP_Widget {
...
'immigration_social_widget', 


// Widget name will appear in UI
esc_html__( '[ Immigration ] Social Widget', 'immigration-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'immigration-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'immigration-companion' );
}
...
} // Class immigration_social_widget ends here


// Register and load the widget
function immigration_social_load_widget() {
	register_widget( 'immigration_social_widget' );
}
add_action( 'widgets_init', 'immigration_social_load_widget' );