...
function immigration_instagram_instance() {
...
// Blog Section
function immigration_blog_section( $postnumber ) {
...
// 
function immigration_section_heading( $title = '', $subtitle = '' ) {
    if( $title || $subtitle ):
    ?>
...
function immigration_contact7_form_content( $template, $prop ) {
...
add_filter( 'wpcf7_default_template', 'immigration_contact7_form_content', 10, 2 );
