 ...
 * @since 1.0
 */
class Immigration_Contact extends Widget_Base {

    public function get_name() {
        return 'immigration-contact';
    }

    public function get_title() {
        return __( 'Contact', 'immigration-companion' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_map',
            [
                'label' => __( 'Map Settings', 'immigration-companion' ),
            ]
        );
        $this->add_control(
            'map_switch',
            [
                'label' => __( 'Show Map', 'immigration-companion' ),
        ...
        $this->add_control(
            'map_address',
            [
                'label'         => esc_html__( 'Address', 'immigration-companion' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'Rabindra Sorobor Dhanmondi Lake Rd', 'immigration-companion' ),
                'description'   => esc_html__( 'Before use map widget make sure you are set google map api key from customizer -> theme options -> general -> google map api key', 'immigration-companion' )
            ]
        );
        $this->add_control(
            'map_lat',
            [
                'label'       => esc_html__( 'Latitude', 'immigration-companion' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
        ...
        $this->add_control(
            'map_lng',
            [
                'label'       => esc_html__( 'Longitude', 'immigration-companion' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( '90.377155', 'immigration-companion' )
            ]
        );
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'immigration-companion' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'immigration-companion' ),
                ...
                'fields'  => [
                    [
                        ...
                        'label_block' => true,
                        'type'        => Controls_Manager::TEXT,
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'immigration-companion' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'immigration-companion' ),
                        'type'    => Controls_Manager::WYSIWYG,
                        'default' => esc_html__( 'Write something...', 'immigration-companion' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'immigration-companion' ),
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'immigration-companion' ),
            ]
        );
        $this->add_control(
            'contact_formshortcode',
            [
                'label'     => esc_html__( 'Form Shortcode', 'immigration-companion' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true
            ]
        );
        ...
        $this->start_controls_section(
            'style_content_color', [
                'label' => __( 'Style Content Color', 'immigration-companion' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'color_btntext', [
                'label'     => __( 'Text color', 'immigration-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ffffff',
                'selectors' => [
        ...
        $this->add_control(
            'color_border', [
                'label'     => __( 'Heading color', 'immigration-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ffffff',
                'selectors' => [
        ...
        $this->add_control(
            'color_fbtntextcolor', [
                'label'     => __( 'Form Button Label color', 'immigration-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222222',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhovlc', [
                'label'     => __( 'Form Button Hover Label color', 'immigration-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#00ff8c',
                'selectors' => [
    ...
    wp_enqueue_script('immigration-map-custom');
                    ...
                    ?>
                        <div class="single-contact-address d-flex flex-row">
                            ...
                            <div class="contact-details">
                                ...
                                //
                                if( ! empty( $info['desc'] ) ) {
                                    echo immigration_get_textareahtml_output( $info['desc'] );
                                }
                                ?>
                            </div>
                        </div>
