...
class Immigration_Features extends Widget_Base {
	...
	public function get_title() {
		return __( 'Features', 'immigration-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_heading',
            [
                'label' => __( 'Features Section Heading', 'immigration-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'features_block',
			[
				'label' => __( 'Features', 'immigration-companion' ),
			]
		);
		$this->add_control(
            'features_content', [
                'label' => __( 'Create Features', 'immigration-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name' => 'fonticon',
                        'label' => __( 'Font Icon', 'immigration-companion' ),
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'immigration-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'immigration-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Font Icon', 'immigration-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_fonticon', [
                'label'     => __( 'Font Icon Color', 'immigration-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Descriptions', 'immigration-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
