...
if ( !class_exists( 'Immigration_El_Widgets' ) ) {
    ...
    final class Immigration_El_Widgets {
        ...
        public function __clone() {
            ...
            _doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'immigration-companion' ), '1.7.0' );
        }
        ...
        public function admin_notice_missing_main_plugin() {
            ...
            /* translators: 1: Elementor */
                esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'immigration-companion' ),
                '<strong>' . esc_html__( 'Immigration Theme', 'immigration-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'Elementor', 'immigration-companion' ) . '</strong>'
            );
        ...
        public function admin_notice_minimum_elementor_version() {
            ...
            /* translators: 1: Elementor 2: Required Elementor version */
                esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'immigration-companion' ),
                '<strong>' . esc_html__( 'Immigration', 'immigration-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'Elementor', 'immigration-companion' ) . '</strong>',
        ...
        public function admin_notice_minimum_php_version() {
            ...
            /* translators: 1: PHP 2: Required PHP version */
                esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'immigration-companion' ),
                '<strong>' . esc_html__( 'Immigration', 'immigration-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'PHP', 'immigration-companion' ) . '</strong>',
        ...
        public function add_elementor_category() {
            ...
            \Elementor\Plugin::instance()->elements_manager->add_category( 'immigration-elements', [
                'title' => __( 'Immigration Elements', 'immigration-companion' ),
            ], 1 );
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            /******************
                Enqueue Css
            ******************/
            wp_enqueue_style( 'owl-carousel', plugins_url( 'assets/css/owl.carousel.css', __FILE__ ), array(), '1.0.0', 'all' );
            wp_enqueue_style( 'justifiedGallery', plugins_url( 'assets/css/justifiedGallery.min.css', __FILE__ ), array(), '3.7.0', 'all' );
            ...
            ******************/
            ...
            wp_register_script( 'immigration-map-custom', plugins_url( 'assets/js/map-custom.js', __FILE__ ), array('jquery'), '1.0', true );

            wp_enqueue_script( 'justifiedGallery', plugins_url( 'assets/js/jquery.justifiedGallery.min.js', __FILE__ ), array('jquery'), '1.0', true );

            // immigration companion main js
            wp_enqueue_script( 'immigration-companion', plugins_url( 'assets/js/immigration-companion-main.js', __FILE__ ), array( 'jquery', 'jquery-ui-datepicker' ), '1.0', true );
        ...
        public function register_widget_styles() {
            // Typing Effect
            wp_enqueue_style( 'immigration-companion-elementor-edit', plugins_url( '/assets/css/elementor-edit.css', __FILE__ ) );
        }
